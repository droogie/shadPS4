...
// error codes
constexpr int ORBIS_NET_CTL_ERROR_NOT_INITIALIZED = 0x80412101;
...
constexpr int ORBIS_NET_CTL_ERROR_INVALID_SIZE = 0x80412111;
...
constexpr int ORBIS_NET_CTL_EVENT_TYPE_DISCONNECT_REQ_FINISHED = 2;
