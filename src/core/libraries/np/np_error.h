...
constexpr int ORBIS_NP_SCORE_INVALID_ARGUMENT = 0x80550704;
constexpr int ORBIS_NP_SCORE_ERROR_NOT_FOUND = 0x80550812;
constexpr int ORBIS_NP_WEB_API_INVALID_ARGUMENT = 0x80552902;